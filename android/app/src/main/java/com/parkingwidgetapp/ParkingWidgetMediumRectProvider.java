...
public class ParkingWidgetMediumRectProvider extends AppWidgetProvider {
    ...
    public static void updateWidget(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                ...
                android.util.Log.d("ParkingWidgetMediumRect", "MediumRect widget location: " + parkingLocation);
            }
            cursor.close();
            ...
            if (timestampCursor.moveToFirst()) {
                ...
                android.util.Log.d("ParkingWidgetMediumRect", "MediumRect widget timestamp: " + savedTimestamp);
            }
            ...
            android.util.Log.e("ParkingWidgetMediumRect", "Error reading from AsyncStorage: " + e.getMessage());
        ...
        for (int widgetId : appWidgetIds) {
            RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.widget_parking_medium_rect);
    ...
    public static void updateAllWidgets(Context context) {
        ...
        ComponentName componentName = new ComponentName(context, ParkingWidgetMediumRectProvider.class);
    ...
    private void scheduleNextUpdate(Context context) {
        ...
        Intent intent = new Intent(context, ParkingWidgetMediumRectProvider.class);
