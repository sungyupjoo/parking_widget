...
public class ParkingWidgetWideProvider extends AppWidgetProvider {
    ...
    public static void updateWidget(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                ...
                android.util.Log.d("ParkingWidgetWide", "Wide widget location: " + parkingLocation);
            }
            cursor.close();
            ...
            if (timestampCursor.moveToFirst()) {
                ...
                android.util.Log.d("ParkingWidgetWide", "Wide widget timestamp: " + savedTimestamp);
            }
            ...
            android.util.Log.e("ParkingWidgetWide", "Error reading from AsyncStorage: " + e.getMessage());
        ...
        for (int widgetId : appWidgetIds) {
            RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.widget_parking_wide);
    ...
    public static void updateAllWidgets(Context context) {
        ...
        ComponentName componentName = new ComponentName(context, ParkingWidgetWideProvider.class);
    ...
    private void scheduleNextUpdate(Context context) {
        ...
        Intent intent = new Intent(context, ParkingWidgetWideProvider.class);
