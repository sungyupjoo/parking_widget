...
public class ParkingWidgetLargeProvider extends AppWidgetProvider {
    ...
    public static void updateWidget(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                ...
                android.util.Log.d("ParkingWidgetLarge", "Large widget location: " + parkingLocation);
            }
            cursor.close();
            ...
            if (timestampCursor.moveToFirst()) {
                ...
                android.util.Log.d("ParkingWidgetLarge", "Large widget timestamp: " + savedTimestamp);
            }
            ...
            android.util.Log.e("ParkingWidgetLarge", "Error reading from AsyncStorage: " + e.getMessage());
        ...
        for (int widgetId : appWidgetIds) {
            RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.widget_parking_large);
    ...
    public static void updateAllWidgets(Context context) {
        ...
        ComponentName componentName = new ComponentName(context, ParkingWidgetLargeProvider.class);
    ...
    private void scheduleNextUpdate(Context context) {
        ...
        Intent intent = new Intent(context, ParkingWidgetLargeProvider.class);
