...
public class ParkingWidgetExtraWideProvider extends AppWidgetProvider {
    ...
    public static void updateWidget(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                ...
                android.util.Log.d("ParkingWidgetExtraWide", "ExtraWide widget location: " + parkingLocation);
            }
            cursor.close();
            ...
            if (timestampCursor.moveToFirst()) {
                ...
                android.util.Log.d("ParkingWidgetExtraWide", "ExtraWide widget timestamp: " + savedTimestamp);
            }
            ...
            android.util.Log.e("ParkingWidgetExtraWide", "Error reading from AsyncStorage: " + e.getMessage());
        ...
        for (int widgetId : appWidgetIds) {
            RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.widget_parking_extrawide);
    ...
    public static void updateAllWidgets(Context context) {
        ...
        ComponentName componentName = new ComponentName(context, ParkingWidgetExtraWideProvider.class);
    ...
    private void scheduleNextUpdate(Context context) {
        ...
        Intent intent = new Intent(context, ParkingWidgetExtraWideProvider.class);
